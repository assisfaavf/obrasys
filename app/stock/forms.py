...
from stock.models import StockBalance, StockMovement, StockMovementType
...
class StockMovementAdminForm(forms.ModelForm):
    ...
    class Meta:
        model = StockMovement
        fields = ("material", "location", "movement_type", "quantity", "available_quantity", "balance_after_display", "note")
